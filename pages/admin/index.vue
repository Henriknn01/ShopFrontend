...
import {ArrowRightOnRectangleIcon, Cog6ToothIcon, TruckIcon, ChartPieIcon, PencilSquareIcon, PhotoIcon, ShoppingCartIcon} from "@heroicons/vue/24/outline";
definePageMeta({
    middleware: isAdmin
});
        ...
        <div class="grid grid-cols-4 gap-8 auto-rows-auto">
            <div class="md:col-span-1 col-span-full bg-gray-50 rounded p-2 shadow-xl h-fit">
                <div class="rounded p-2.5 mb-2 hover:bg-gray-100 cursor-pointer">
                    <h3 class="text-md font-semibold inline-flex gap-2"><ChartPieIcon class="h-6 w-6 text-gray-500" />Dashboard</h3>
                </div>
                <div class="bg-gray-200 rounded p-2.5 mb-2 hover:bg-gray-100 cursor-pointer">
                    <h3 class="text-md font-semibold inline-flex gap-2"><TruckIcon class="h-6 w-6 text-gray-500" />New orders</h3>
                </div>
                <div class="rounded p-2.5 mb-2 hover:bg-gray-100 cursor-pointer">
                    <h3 class="text-md inline-flex gap-2"><ShoppingCartIcon class="h-6 w-6 text-gray-500" />Products</h3>
                </div>
                <div class="rounded p-2.5 mb-2 hover:bg-gray-100 cursor-pointer">
                    <h3 class="text-md inline-flex gap-2"><PhotoIcon class="h-6 w-6 text-gray-500" />Images</h3>
                </div>
                <div class="rounded p-2.5 mb-2 hover:bg-gray-100 cursor-pointer">
                    <h3 class="text-md inline-flex gap-2"><PencilSquareIcon class="h-6 w-6 text-gray-500" />Blog</h3>
                </div>
                <div class="rounded p-2.5 mb-2 hover:bg-gray-100 cursor-pointer">
